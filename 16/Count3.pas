...
PROCEDURE Bump; {увеличиваем счетчик на 1}
...
PROCEDURE Bump;
  {Увеличивает определенный счетчик на 1, а именно один из Ones, Tens, Hundreds, в диапазоне от 0 до 999 включительно}
...
{V1 := Ones, V10 := Tens, V100 := Hundreds}
BEGIN {Value}
  V100 := Hundreds;
  V10 := Tens;
  V1 := Ones
