...
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month); {—читывает название мес€ца}
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month); {¬ыводит название мес€ца}

IMPLEMENTATION
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
{Ch1 := a, Ch2 := b, Ch3 := c, где a, b, c - символы из первых 3 букв названий мес€цев  в верхнем регистре}
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN{ReadMonth}
...
{¬ыводит первые три буквы названи€ мес€ца в верхнем регистре}
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {WriteMonth}
